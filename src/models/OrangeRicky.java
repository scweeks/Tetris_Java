...
public class OrangeRicky extends Tetromino
{
	public OrangeRicky ()
	{
		super.r1.setLocation( -Tetromino.SIZE, 0 );
		super.r2.setLocation ( 0, 0 );
		super.r3.setLocation ( Tetromino.SIZE, 0 );
		super.r4.setLocation ( Tetromino.SIZE, -Tetromino.SIZE );
		super.r1.setFillColor ( new Color ( 255, 127, 0 ) );
		super.r2.setFillColor ( new Color ( 255, 127, 0 ) );
		super.r3.setFillColor ( new Color ( 255, 127, 0 ) );
		super.r4.setFillColor ( new Color ( 255, 127, 0 ) );
