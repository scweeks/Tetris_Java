...
public class RhodeIslandZ extends Tetromino
{
	public RhodeIslandZ ()
	{
		...
		super.r1.setFillColor ( new Color ( 0, 255, 0 ) );
		super.r2.setFillColor ( new Color ( 0, 255, 0 ) );
		super.r3.setFillColor ( new Color ( 0, 255, 0 ) );
		super.r4.setFillColor ( new Color ( 0, 255, 0 ) );
