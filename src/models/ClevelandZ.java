...
public class ClevelandZ extends Tetromino
{
	public ClevelandZ ()
	{
		...
		super.r1.setFillColor ( new Color ( 255, 0, 0 ) );
		super.r2.setFillColor ( new Color ( 255, 0, 0 ) );
		super.r3.setFillColor ( new Color ( 255, 0, 0 ) );
		super.r4.setFillColor ( new Color ( 255, 0, 0 ) );
