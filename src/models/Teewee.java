...
public class Teewee extends Tetromino
{
	public Teewee ()
	{
		...
		super.r1.setFillColor ( new Color ( 128, 0, 128 ) );
		super.r2.setFillColor ( new Color ( 128, 0, 128 ) );
		super.r3.setFillColor ( new Color ( 128, 0, 128 ) );
		super.r4.setFillColor ( new Color ( 128, 0, 128 ) );
